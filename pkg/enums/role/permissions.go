...
const (
	...
	DownloadOthersFiles Permission = "DOWNLOAD_OTHERS_FILES" // DownloadOthersFiles grants permission to download files that are not owned by the authenticated user.
